  ...
  try {
    ...
    return (
      <>
        ...
        <div className="grid grid-cols-1 gap-y-4 text-center lg:grid-cols-2 items-center justify-items-center gap-10 my-8 w-4/5 mx-auto">
      ...
      return (
        <>
          <div className="alert alert-error shadow-lg w-2/4 mx-auto mt-24">
            <div>
