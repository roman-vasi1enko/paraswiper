...
def assets_path(relative_path):
    ...
    return os.path.join(os.path.abspath("worker/corePyApp/Scripts/confusablesCustom/assets"), relative_path) # If running as script, specifies resource folder as /assets
